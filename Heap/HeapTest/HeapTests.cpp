...
/// <summary>
/// ѕроверить сохранила ли куча свойства кучи.
/// </summary>
/// <typeparam name="T">“ип данных кучи</typeparam>
...
/// <summary>
/// явл€етс€ ли вектор минимальной кучей.
/// </summary>
/// <param name="vector">¬ектор который нужно проверить.</param>
/// <param name="index">»ндекс с которого начать проверку.</param>
/// <typeparam name="T">“ип данных который содержит вектор.</typeparam>
template <typename T>
